...
//       <div className="max-w-8xl mx-auto px-6 py-4 flex items-center justify-between font-instrument">
//         {/* Logo */}
...
//           <ul className="flex items-center gap-6 text-[16px] text-black">
...
//             </li>
//           </ul>
//           <button className="flex items-center gap-2 bg-[#F36B2D] text-white px-5 py-2 rounded-full font-semibold hover:bg-[#e75f1f] transition-all duration-300">
...
//       <button
//         onClick={() => setIsOpen(false)}
//         className="flex items-center gap-2 bg-[#F36B2D] text-white px-6 py-3 rounded-full font-semibold hover:bg-[#e75f1f] transition-all duration-300"
//       >
